import svgPaths from "./svg-zyru58hxb5";
...
function ArrowRight() {
  return (
    <div className="absolute left-[125.61px] size-[20px] top-[4px]" data-name="ArrowRight">
...
function Link() {
  return (
    <div className="h-[28px] relative shrink-0 w-[145.609px]" data-name="Link">
...
function Button() {
  return (
    <div className="bg-[#0a0a0a] h-[60px] relative rounded-[33554400px] shrink-0 w-[209.609px]" data-name="Button">
  ...
  return (
    <div className="h-[28px] relative shrink-0 w-[104.969px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <p className="font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[28px] relative shrink-0 text-[#0a0a0a] text-[18px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 9" }}>
          Get in Touch
        </p>
      </div>
    </div>
...
function Button1() {
  return (
    <div className="h-[62px] relative rounded-[33554400px] shrink-0 w-[170.969px]" data-name="Button">
...
function Div3() {
  return (
    <div className="absolute content-stretch flex gap-[16px] h-[62px] items-center left-0 top-[486px] w-[576px]" data-name="div">
      <Button />
      <Button1 />
    </div>
  );
...
function MotionDiv() {
  return (
    <div className="absolute h-[548px] left-0 top-0 w-[576px]" data-name="motion.div">
      <Div2 />
      <H />
      <P />
      <Div3 />
...
function MotionDiv1() {
  return (
    <div className="absolute gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(2,minmax(0,1fr))] h-[316px] left-[640px] top-[116px] w-[576px]" data-name="motion.div">
      <Div4 />
      <Div5 />
      <Div6 />
      <Div7 />
...
function Div1() {
  return (
    <div className="flex-[1_0_0] h-[548px] min-h-px min-w-px relative" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <MotionDiv />
        <MotionDiv1 />
      </div>
...
function P17() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#7a7570] text-[14px] top-0 tracking-[1.4px] uppercase whitespace-nowrap">About Me</p>
    </div>
  );
}
...
function H5() {
  return (
    <div className="h-[144px] relative shrink-0 w-full" data-name="h2">
      <p className="absolute font-['Playfair_Display:Regular',sans-serif] leading-[48px] left-0 not-italic text-[#0a0a0a] text-[48px] top-0 w-[562px]">Design is about solving problems, not just making things pretty</p>
    </div>
  );
}
...
function P18() {
  return (
    <div className="h-[84px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[28px] left-0 text-[#7a7570] text-[20px] top-0 w-[564px]" style={{ fontVariationSettings: "'opsz' 9" }}>{`With 8+ years of experience in UX/UI design, I've had the privilege of working with startups, agencies, and Fortune 500 companies to create digital products that users love.`}</p>
    </div>
  );
}
...
function Div14() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[280px] items-start left-0 top-0 w-[576px]" data-name="div">
      <P17 />
      <H5 />
      <P18 />
    </div>
...
function ArrowRight2() {
  return (
    <div className="absolute left-0 size-[20px] top-[24px]" data-name="ArrowRight">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="ArrowRight">
          <path d="M4.16667 10H15.8333" id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p1ae0b780} id="Vector_2" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
...
function Link3() {
  return (
    <div className="absolute h-[44px] left-[24px] top-[12px] w-[114.281px]" data-name="Link">
      <p className="-translate-x-1/2 absolute font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[24px] left-[57.5px] text-[#0a0a0a] text-[16px] text-center top-0 whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 9" }}>
        More About Me
      </p>
      <ArrowRight2 />
    </div>
...
function Button3() {
  return (
    <div className="absolute h-[68px] left-0 rounded-[33554400px] top-[312px] w-[162.281px]" data-name="Button">
      <Link3 />
    </div>
  );
}
...
function MotionDiv5() {
  return (
    <div className="absolute h-[380px] left-0 top-0 w-[576px]" data-name="motion.div">
      <Div14 />
      <Button3 />
    </div>
  );
...
function H6() {
  return (
    <div className="content-stretch flex h-[32px] items-start relative shrink-0 w-full" data-name="h3">
      <p className="flex-[1_0_0] font-['Playfair_Display:Regular',sans-serif] leading-[32px] min-h-px min-w-px not-italic relative text-[#0a0a0a] text-[24px]">My Approach</p>
    </div>
  );
}
...
function P19() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[24px] left-0 text-[#7a7570] text-[16px] top-0 w-[499px]" style={{ fontVariationSettings: "'opsz' 9" }}>
        I believe in a human-centered design process that starts with deep user research and ends with delightful, accessible experiences.
      </p>
    </div>
  );
}
...
function Div15() {
  return (
    <div className="bg-white h-[158px] relative rounded-[12px] shrink-0 w-full" data-name="div">
      <div aria-hidden="true" className="absolute border border-[rgba(10,10,10,0.1)] border-solid inset-0 pointer-events-none rounded-[12px]" />
...
function H7() {
  return (
    <div className="content-stretch flex h-[32px] items-start relative shrink-0 w-full" data-name="h3">
      <p className="flex-[1_0_0] font-['Playfair_Display:Regular',sans-serif] leading-[32px] min-h-px min-w-px not-italic relative text-[#0a0a0a] text-[24px]">Collaboration</p>
    </div>
  );
}
...
function P20() {
  return (
    <div className="h-[72px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[24px] left-0 text-[#7a7570] text-[16px] top-0 w-[503px]" style={{ fontVariationSettings: "'opsz' 9" }}>
        I work closely with developers, product managers, and stakeholders to ensure designs are not only beautiful but also technically feasible and aligned with business goals.
      </p>
    </div>
  );
}
...
function Div16() {
  return (
    <div className="bg-white h-[182px] relative rounded-[12px] shrink-0 w-full" data-name="div">
      <div aria-hidden="true" className="absolute border border-[rgba(10,10,10,0.1)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="content-stretch flex flex-col gap-[12px] items-start pb-px pt-[33px] px-[33px] relative size-full">
        <H7 />
        <P20 />
...
function MotionDiv6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[364px] items-start left-[640px] top-[8px] w-[576px]" data-name="motion.div">
      <Div15 />
      <Div16 />
    </div>
  );
...
function Section2() {
  return (
    <div className="absolute h-[380px] left-[162.5px] top-[2097px] w-[1216px]" data-name="Section">
      <MotionDiv5 />
      <MotionDiv6 />
    </div>
  );
...
function H8() {
  return (
    <div className="absolute h-[96px] left-[354.5px] top-[96px] w-[832px]" data-name="h2">
      <p className="-translate-x-1/2 absolute font-['Playfair_Display:Regular',sans-serif] leading-[48px] left-[416.23px] not-italic text-[#f7f5f1] text-[48px] text-center top-0 w-[832px]">{`Let's work together to create impactful designs`}</p>
    </div>
  );
}
...
function P21() {
  return (
    <div className="absolute h-[56px] left-[434.5px] opacity-80 top-[224px] w-[672px]" data-name="p">
      <p className="-translate-x-1/2 absolute font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[28px] left-[336.39px] text-[#f7f5f1] text-[18px] text-center top-0 w-[649px]" style={{ fontVariationSettings: "'opsz' 9" }}>{`I'm always open to discussing new projects, creative ideas, or opportunities to be part of your vision.`}</p>
    </div>
  );
}
...
function Link4() {
  return (
    <div className="absolute h-[28px] left-[32px] top-[16px] w-[170.984px]" data-name="Link">
      <p className="-translate-x-1/2 absolute font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[28px] left-[85.5px] text-[#0a0a0a] text-[18px] text-center top-0 whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 9" }}>
...
function Button4() {
  return (
    <div className="absolute bg-[#c8ff00] h-[60px] left-[653px] rounded-[33554400px] top-[312px] w-[234.984px]" data-name="Button">
      <Link4 />
    </div>
  );
}
...
function MotionDiv7() {
  return (
    <div className="absolute bg-[#0a0a0a] h-[468px] left-0 top-[2605px] w-[1541px]" data-name="motion.div">
      <H8 />
      <P21 />
      <Button4 />
    </div>
...
function ArrowUp() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="ArrowUp">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="ArrowUp">
          <path d={svgPaths.p32002100} id="Vector" stroke="var(--stroke-0, #F7F5F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M10 15.8333V4.16667" id="Vector_2" stroke="var(--stroke-0, #F7F5F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function MotionButton() {
  return (
    <div className="absolute bg-[#0a0a0a] content-stretch flex items-center justify-center left-[1453px] rounded-[33554400px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] size-[56px] top-[2523px]" data-name="motion.button">
      <ArrowUp />
    </div>
  );
}
...
function Nav() {
  return (
    <div className="absolute bg-[rgba(247,245,241,0.9)] content-stretch flex flex-col h-[81px] items-start left-0 pb-px px-[162.5px] top-[1666px] w-[1541px]" data-name="nav">
      <div aria-hidden="true" className="absolute border-[rgba(10,10,10,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <Div18 />
    </div>
  );
}
